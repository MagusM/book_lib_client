...
const WelcomeScreen: React.FC = () => {
  ...
  const setUsernameDebounced = useRef(
  ...
  function validateInput() {
    ...
    if (usernameRef.current.length === 0) {
      ...
      usernameRef.current.length < 2 ||
      usernameRef.current.length > 20
    ) {
    ...
    <div className="flex h-screen flex-col md:flex-row w-full">
      <div className="flex-1 bg-white flex w-full h-full justify-center py-20 sm:py-56">
        <div className="sm:w-[50%] w-[95%] mx-auto px-4 sm:py-4">
          ...
          <h2 className="text-3xl font-bold text-gray-900 sm:mb-4">
            {t("WelcomePage.welcome")}
          </h2>
          <p className="text-gray-500 mb-10 sm:mb-20">
            {t("WelcomePage.secondaryWelcome")}
          </p>
      ...
      <div
        className="flex-1 w-full -mt-[200px] sm:mt-0 bg-gray-100 bg-cover bg-center"
        style={{
